				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Nitrozeus<br>
							 Блог о программировании</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Всем привет! Hello world! Я Nitro и на моем сайте много разных крутых статей на самые разные темы! Наслаждайтесь. И, кстати, в footer-е есть исходный код этого сайте, если это кому 
								 то интересно
							</p>
